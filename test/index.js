...
describe('Statusify - Self Reporting', () => {
  ...
  describe('Unsuccessful POSTs', () => {
    it('should reject an improperly formatted JSON RPC body with 400 err');
    it('should reject messages with 400 err when node id is not valid');
    it('should reject messages with 400 err when node address is not valid');
    it('should reject messages with 400 err when payment address can not be decrypted');
    it('should reject messages with 400 err when signature is invalid');
  });
